...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('/principal/css/bootstrap.css') }}">
    <link rel="stylesheet" href="{{ asset('/principal/css/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('/principal/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/principal/css/bootstrap-datepicker.css') }}">
    <link rel="stylesheet" href="{{ asset('/principal/css/jquery.timepicker.css') }}">

    <link rel="stylesheet" href="{{ asset('/principal/fonts/ionicons/css/ionicons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/principal/fonts/fontawesome/css/font-awesome.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/principal/fonts/flaticon/font/flaticon.css') }}">
  ...
  <body>
    ...
    <header role="banner">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
          <a class="navbar-brand" href="index.html">Clinica Oftalmologica<span></span>  </a>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  ...
                  <a class="dropdown-item" href="#">Medida de la vista</a>
                  <a class="dropdown-item" href="services.html">SCTR</a>
                </div>

              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="doctors.html" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Medico</a>
                <div class="dropdown-menu" aria-labelledby="dropdown05">
                  <a class="dropdown-item" href="doctors.html">Experiencia</a>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('principal/img/slider-2.jpg');">
        
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 element-animate">
              <h1>Clinica Oftalmologica Especializada</h1>
              <p>Realizamos medidas de la vista y tratamos enfermedades oftalmicas con las ultimas tendencias en el campo.</p>
            </div>
          </div>
        </div>
      ...
      <div class="slider-item" style="background-image: url('principal/img/slider-1.jpg');">
        <div class="container">
          <div class="row slider-text align-items-center">
            <div class="col-md-7 col-sm-12 element-animate">
      ...
      <div class="row">
        <div class="col-md-4 p-0 one-col element-animate">
          <div class="col-inner p-xl-5 p-lg-5 p-md-4 p-sm-4 p-4">
            ...
            <h2>Servicios al Paciente</h2>
            <p>El paciente podra contar con un servicio perzonalizado</p>
          </div>
        ...
        <div class="col-md-4 p-0 two-col element-animate">
          <div class="col-inner p-xl-5 p-lg-5 p-md-4 p-sm-4 p-4">
            ...
            <p>Realizamos el tratamiento de los ojos con sus respectivos procedimientos</p>
          </div>
          <a href="#" class="btn-more">Leer Mas</a>
        </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6 stretch-left-1 element-animate" data-animate-effect="fadeInLeft">
            <a href="#" class="video"><img src="{{ asset('/principal/img/img_1.jpg') }}" alt="" class="img-fluid"></a>
          </div>
          ...
          <div class="major-caousel js-carousel-1 owl-carousel">
            <div>
              <div class="media d-block media-custom text-center">
                <img src="{{ asset('/principal/img/doctor_1.jpg') }}" alt="Image Placeholder" class="img-fluid">
                <div class="media-body">
            ...
            <div>
              <div class="media d-block media-custom text-center">
                <img src="{{ asset('/principal/img/doctor_2.jpg') }}" alt="Image Placeholder" class="img-fluid">
                <div class="media-body">
            ...
            <div>
              <div class="media d-block media-custom text-center">
                <img src="{{ asset('/principal/img/doctor_3.jpg') }}" alt="Image Placeholder" class="img-fluid">
                <div class="media-body">
            ...
            <div>
              <div class="media d-block media-custom text-center">
                <img src="{{ asset('/principal/img/doctor_4.jpg') }}" alt="Image Placeholder" class="img-fluid">
                <div class="media-body">
    ...
    <section class="cover_1" style="background-image: url(principal/img/bg_1.jpg);">
      <div class="container">
          ...
          <div class="major-caousel js-carousel-2 owl-carousel">
            <div>
              <div class="media d-block media-custom text-left">
                <img src="{{ asset('/principal/img/img_thumb_1.jpg') }}" alt="Image Placeholder" class="img-fluid">
                <div class="media-body">
            ...
            <div>
              <div class="media d-block media-custom text-left">
                <img src="{{ asset('/principal/img/img_thumb_2.jpg') }}" alt="Image Placeholder" class="img-fluid">
                <div class="media-body">
                  <span class="meta-post">December 2, 2017</span>
                  <h3 class="mt-0 text-black"><a href="#" class="text-black">Lorem ipsum dolor sit amet elit</a></h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
            ...
            <div>
              <div class="media d-block media-custom text-left">
                <img src="{{ asset('/principal/img/img_thumb_3.jpg') }}" alt="Image Placeholder" class="img-fluid">
                <div class="media-body">
                  <span class="meta-post">December 2, 2017</span>
                  <h3 class="mt-0 text-black"><a href="#" class="text-black">Lorem ipsum dolor sit amet elit</a></h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
            ...
            <div>
              <div class="media d-block media-custom text-left">
                <img src="{{ asset('/principal/img/img_thumb_4.jpg') }}" alt="Image Placeholder" class="img-fluid">
                <div class="media-body">
                  <span class="meta-post">December 2, 2017</span>
                  <h3 class="mt-0 text-black"><a href="#" class="text-black">Lorem ipsum dolor sit amet elit</a></h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
    ...
    <script src="{{ asset('/principal/js/jquery-3.2.1.min.js') }}"></script>
    <script src="{{ asset('/principal/js/popper.min.js') }}"></script>
    <script src="{{ asset('/principal/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('/principal/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('/principal/js/bootstrap-datepicker.js') }}"></script>
    <script src="{{ asset('/principal/js/jquery.timepicker.min.js') }}"></script>
    <script src="{{ asset('/principal/js/jquery.waypoints.min.js') }}"></script>
