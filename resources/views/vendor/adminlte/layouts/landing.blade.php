...
<head>
    ...
    <title>Clinica Oftalmologica Bernardo Gamarra</title>
...
<div id="app" v-cloak>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="#desc" class="smoothScroll">Informacion</a></li>
                    <li><a href="#Servicio" class="smoothScroll">Servicios</a></li>
                    <li><a href="#precio" class="smoothScroll">Precio</a></li>                    
    ...
    <section id="home" name="home">        
            <div class="container">
                <div class="row centered">
                    <h1>Clinica Oftalmologica</h1>
                    <h2>Dr. Bernardo Gamarra</h2>
    ...
    <section id="Servicio" name="Servicio">
        <div id="showcase">
            <div class="container">
                <div class="row">
